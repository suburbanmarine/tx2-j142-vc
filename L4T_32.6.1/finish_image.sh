...
chroot --userspec=+1000:+1000 /home/buildbot/Linux_for_Tegra/rootfs /bin/bash -c "cd /home/mbari && git clone https://github.com/RidgeRun/gst-interpipe.git"
chroot --userspec=+1000:+1000 /home/buildbot/Linux_for_Tegra/rootfs /bin/bash -c "cd /home/mbari/gst-interpipe && git checkout v1.1.8"
...
chroot --userspec=+1000:+1000 /home/buildbot/Linux_for_Tegra/rootfs /bin/bash -c "cd /home/mbari     && git clone https://github.com/ZeroCM/zcm.git"
...
chroot --userspec=+1000:+1000 /home/buildbot/Linux_for_Tegra/rootfs /bin/bash -c "cd /home/mbari && git clone https://github.com/suburbanmarine/opaleye.git"
